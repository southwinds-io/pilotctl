module southwinds.dev/pilotctl/receivers/mongo

go 1.19

replace (
	southwinds.dev/artisan => ../../../artisan
	southwinds.dev/http => ../../../http // needed as it is a pilotctl dependency
	southwinds.dev/pilotctl => ../../
)
...
require (
	...
	southwinds.dev/artisan v0.0.0-00010101000000-000000000000 // indirect
)
